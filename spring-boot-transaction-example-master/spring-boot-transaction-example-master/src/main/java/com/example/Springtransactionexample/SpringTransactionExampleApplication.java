...
public class SpringTransactionExampleApplication {
	...
	public static void main(String[] args) {
		 ...
		 * ClassPathXmlApplicationContext("Beans.xml")) { // Let us raise // a start //
		 * event. context.start();
		 * 
		 * LifeCycleExample obj = (LifeCycleExample)
		 * context.getBean("lifeCycleExample"); System.out.println(obj.getParam()); //
		 * obj.getParam();
		 * 
